...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('addresses', function (Blueprint $table) {
            ...
            $table->string('village', 255)->comment('Desa');
            ...
            $table->string('address_coordinates', 50)->nullable()->default(null)->comment('Koordinat Alamat');
            $table->string('transportation', 255)->comment('Transportasi');
            $table->string('distance', 255)->comment('Jarak dari rumah ke sekolah');
