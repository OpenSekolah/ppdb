        ...
        <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span class="block text-gray-500">Jumlah Pendaftar</span>
                </div>
            </div>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span class="block text-gray-500">Data Sekolah</span>
                </div>
            </div>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    <span class="block text-2xl font-bold">355</span>
                    <span class="block text-gray-500">Jumlah Kuota</span>
                </div>
            </div>
        </section>
        
        <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6 mt-7">
            <div class="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                <div class="px-6 py-5 font-semibold border-b border-gray-100">Grafik Pendaftaran Berdasarkan Jurusan</div>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span class="block text-gray-500">Peserta Daftar Ulang</span>
                </div>
            </div>
            ...
            <div class="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                    ...
                    <span class="block text-gray-500">Belum Mendaftar Ulang</span>
                </div>
            </div>
            ...
            <div class="flex flex-col row-span-3 bg-white shadow rounded-lg">
                <div class="px-6 py-5 font-semibold border-b border-gray-100">Grafik Tagihan PPDB</div>
                <div class="p-4 flex-grow">
